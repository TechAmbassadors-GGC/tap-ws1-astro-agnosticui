...
<Photo src={NinjaTurtlesS3.src} alt="NinjaTurtlesS3" caption="Ninja Turtles at S3 photo" />
<Photo src={NinjaTurtlesASF2.src} alt="NinjaturlesASF2" caption="Ninja Turles at Atlanta Science Festival" />
</div>
...
<Logo src={scratchlogo.src} alt="Scratch Logo"/>
</div>
