...
<Photo src={TapExpo1.src} alt="TapExpo1" caption="Tap Expo 1" />
<Photo src={TapExpo2.src} alt="TapExpo1" caption="Tap Expo 2" />
<Photo src={TapExpo3.src} alt="TapExpo1" caption="Tap Expo 3" />
<Photo src={ASF3.src} alt="ASF3" caption="Atlanta Science Festival" />
</div>
